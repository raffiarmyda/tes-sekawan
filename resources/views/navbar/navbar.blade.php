    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{($title === "Driver") ? 'active' : ''}}" aria-current="page" href="/driver">Data Driver</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{($title === "Vehicle") ? 'active' : ''}}" aria-current="page" href="/vehicle">Data Vehicle</a>
                </li>
                <li class="nav-item">
