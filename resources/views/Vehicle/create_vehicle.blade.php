        ...
        <form method="post" action="{{url('vehicle')}}">
            ...
            <div class="from-group">
                ...
                <input type="text" name="vehicle_name" class="form-control @error('vehicle_name') is-invalid @enderror"
                       id="vehicle_name"
                       placeholder="Masukkan Nama Kendaraan" value="{{old('vehicle_name')}}">
                @error('vehicle_name')
            ...
            <div class="form-group">
                ...
                <select name="type" class="form-select " required>
                    ...
                    <option value="Kendaraan Angkutan Orang" {{old('type') == 'Kendaraan Angkutan Orang' ? 'selected' : ''}}>Kendaraan Angkutan Orang</option>
                    <option value="Kendaraan Angkutan Barang" {{old('type') == 'Kendaraan Angkutan Barang' ? 'selected' : ''}}>Kendaraan Angkutan Barang</option>
                </select>
            </div>
            <div class="form-group">
                ...
                <select name="description" class="form-select " required>
                    ...
                    <option value="Kendaraan Perusahaan" {{old('description') == 'Kendaraan Perusahaan' ? 'selected' : ''}}>Kendaraan Perusahaan</option>
                    <option value="Kendaraan Sewaan" {{old('description') == 'Kendaraan Sewaan' ? 'selected' : ''}}>Kendaraan Sewaan</option>
                </select>
            </div>
            <div class="from-group">
